...
- **First Ready-row spec-surface checks** — dual `tools/call` body and list caching (`ttlMs` / `cacheScope`) are done. ETags, Tasks, HTTP-over-stdio, WIF wait for a wire format. See [docs/spec-surface.md](docs/spec-surface.md).
