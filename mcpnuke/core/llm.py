...
def propose_chains(
    ...
    system = (
        ...
        "If the operator has enabled an out-of-band listener, you may place "
        "the literal token {{oast.url}} in the destination argument of a "
        "sending step (a webhook, request, email, or upload tool) to "
        "demonstrate exfiltration; a callback to that URL proves data left "
        "the target.\n\n"
